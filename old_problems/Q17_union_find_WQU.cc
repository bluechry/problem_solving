...
// Solution
// * QuickUnion과 유사하지만 크기가 작은 component를
//   크기가 큰 component에 연결한다.
...
// Solution
//  * QuickUnion과 코드가 동일하지만 worst case의 runtime cost가 다르다.
//  * Object의 연결로 생성된 tree는 n-ary tree이고,
//    따라서 tree의 높이가 log_n(N)을 넘을 수가 없다.
//  * Worst case의 runtime cost는,
//    '# of id_[] array access = ~lg(N)'
