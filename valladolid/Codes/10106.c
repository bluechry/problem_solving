/* @JUDGE_ID: andrea 10106 C "Arithmatic & Algebra" */
...
int main()
{
	...
	while (gets(num1) != NULL && gets(num2) != NULL) {
		Integer_InitFromString(num1, &op1);
		Integer_InitFromString(num2, &op2);

		Integer_Mult(&op1, &op2, &result);
