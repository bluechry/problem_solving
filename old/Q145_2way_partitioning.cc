...
// * Rearrange the elements such that all elements less than A[i] appear first,
//   followed by elements equal to or larger than A[i].
// * Return the final position of A[i]. Initial A[i] should be located in the
//   right position which is the position of the A[i] when the array is sorted.
...
// * 'lo' points the next element of the elements that is less than the pivot.
...
//   move hi to the next element that is less than the pivot.
